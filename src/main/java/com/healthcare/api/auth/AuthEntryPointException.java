...
@Component
public class AuthEntryPointException extends AbstractBasedAPI implements AuthenticationEntryPoint, Serializable {
	...
	public void commence(HttpServletRequest request, HttpServletResponse response,
		...
		// "UNAUTHORIZED");
		/// throw new ApplicationException(Response.ResultCode.UNAUTHORIZED,
		// "Request is UNAUTHORIZED, token is expired or not set in request
		// header");
