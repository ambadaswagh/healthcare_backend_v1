...
MySQL - 5.6.36 : Database - healthcare_integration_test
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`healthcare_integration_test` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `healthcare_integration_test`;
...
insert  into `schema_version`(`version_rank`,`installed_rank`,`version`,`description`,`type`,`script`,`checksum`,`installed_by`,`installed_on`,`execution_time`,`success`) values (1,1,'1','create install schema','SQL','V1__create_install_schema.sql',-1106509354,'root','2017-07-29 02:29:40',6885,1),(2,2,'1.1','alter table id auto increment','SQL','V1_1__alter_table_id_auto_increment.sql',-757037675,'root','2017-07-29 02:29:46',5681,1),(10,10,'1.10','visit status change datatype selectedtable add','SQL','V1_10__visit_status_change_datatype_selectedtable_add.sql',716491245,'root','2017-07-29 02:29:53',1164,1),(11,11,'1.11','alter tables','SQL','V1_11__alter_tables.sql',-247943960,'root','2017-07-29 02:29:53',186,1),(12,12,'1.12','file upload create','SQL','V1_12__file_upload_create.sql',876211757,'root','2017-07-29 02:29:54',248,1),(13,13,'1.13','add missed columns review','SQL','V1_13__add_missed_columns_review.sql',-1282026214,'root','2017-07-29 02:30:06',12069,1),(14,14,'1.14','add homevisit and caregiver tables','SQL','V1_14__add_homevisit_and_caregiver_tables.sql',-528262379,'root','2017-07-29 02:30:07',890,1),(15,15,'1.15','alter table file upload id auto increment','SQL','V1_15__alter_table_file_upload_id_auto_increment.sql',44106782,'root','2017-07-29 02:30:08',649,1),(16,16,'1.16','add work item and relation with homevisit','SQL','V1_16__add_work_item_and_relation_with_homevisit.sql',1371482745,'root','2017-07-29 02:30:10',1962,1),(17,17,'1.18','add signature to visit and add table content','SQL','V1_18__add_signature_to_visit_and_add_table_content.sql',2135531500,'root','2017-07-29 02:30:11',1451,1),(3,3,'1.2','serviceplan','SQL','V1_2__serviceplan.sql',-1222425101,'root','2017-07-29 02:29:46',357,1),(18,18,'1.20','add id column and alter training has employee','SQL','V1_20__add_id_column_and_alter_training_has_employee.sql',-601009374,'root','2017-07-29 02:30:12',1258,1),(19,19,'1.21','add id column and alter employee has activity','SQL','V1_21__add_id_column_and_alter_employee_has_activity.sql',-838294653,'root','2017-07-29 02:30:14',1402,1),(20,20,'1.22','alter table content  rename columnname table','SQL','V1_22__alter_table_content__rename_columnname_table.sql',-359939850,'root','2017-07-29 02:30:14',94,1),(21,21,'1.23','alter table visit has activity  rename columnname table','SQL','V1_23__alter_table_visit_has_activity__rename_columnname_table.sql',-1963837765,'root','2017-07-29 02:30:14',81,1),(22,22,'1.24','drop pk serviceplan','SQL','V1_24__drop_pk_serviceplan.sql',1990598093,'root','2017-07-29 02:30:15',456,1),(23,23,'1.25','alter table user add token and role','SQL','V1_25__alter_table_user_add_token_and_role.sql',-852953714,'root','2017-07-29 02:30:16',892,1),(24,24,'1.26','add employee clocking tables','SQL','V1_26__add_employee_clocking_tables.sql',491938485,'root','2017-07-29 02:30:16',314,1),(25,25,'1.27','alter table employee add weekly hours worked column','SQL','V1_27__alter_table_employee_add_weekly_hours_worked_column.sql',1169201171,'root','2017-07-29 02:30:17',608,1),(26,26,'1.28','alter table role add position and manager','SQL','V1_28__alter_table_role_add_position_and_manager.sql',-360751973,'root','2017-07-29 02:30:17',734,1),(27,27,'1.29','alter table admin add menulist','SQL','V1_29__alter_table_admin_add_menulist.sql',-2096085755,'root','2017-07-29 02:30:18',758,1),(4,4,'1.3','employee review columns','SQL','V1_3__employee_review_columns.sql',-1633297396,'root','2017-07-29 02:29:47',720,1),(28,28,'1.30','alter table admin add uniquekeyindex username','SQL','V1_30__alter_table_admin_add_uniquekeyindex_username.sql',1502386157,'root','2017-07-29 02:30:18',180,1),(29,29,'1.31','add table health insurance claim','SQL','V1_31__add_table_health_insurance_claim.sql',-477179658,'root','2017-07-29 02:30:19',391,1),(30,30,'1.32','add table employee modify weeklyhourwoked','SQL','V1_32__add_table_employee_modify_weeklyhourwoked.sql',-1219110372,'root','2017-07-29 02:30:20',718,1),(31,31,'1.33','alter health insurance claim table','SQL','V1_33__alter_health_insurance_claim_table.sql',-61313074,'root','2017-07-29 02:30:27',6992,1),(32,32,'1.34','add fk reviewtable for user employee','SQL','V1_34__add_fk_reviewtable_for_user_employee.sql',466629262,'root','2017-07-29 02:30:28',1575,1),(33,33,'1.35','add fk parent key content','SQL','V1_35__add_fk_parent_key_content.sql',1467916156,'root','2017-07-29 02:30:29',788,1),(34,34,'1.37','add columns to health claim insurance','SQL','V1_37__add_columns_to_health_claim_insurance.sql',-1893974463,'root','2017-07-29 02:30:55',26015,1),(35,35,'1.38','add fk to health claim insurance','SQL','V1_38__add_fk_to_health_claim_insurance.sql',2032799834,'root','2017-07-29 02:30:58',3013,1),(36,36,'1.39','add fk document id user visit','SQL','V1_39__add_fk_document_id_user_visit.sql',630809852,'root','2017-07-29 02:31:13',14281,1),(5,5,'1.4','alter table serviceplan','SQL','V1_4__alter_table_serviceplan.sql',-46532266,'root','2017-07-29 02:29:48',727,1),(37,37,'1.40','add language table','SQL','V1_40__add_language_table.sql',671232320,'root','2017-07-29 02:31:13',249,1),(6,6,'1.5','visit review columns','SQL','V1_5__visit_review_columns.sql',-2084313084,'root','2017-07-29 02:29:49',888,1),(7,7,'1.6','drop table sinaturetype unused','SQL','V1_6__drop_table_sinaturetype_unused.sql',-1410366629,'root','2017-07-29 02:29:49',163,1),(8,8,'1.7','visit review columns2','SQL','V1_7__visit_review_columns2.sql',-255248793,'root','2017-07-29 02:29:51',2221,1),(9,9,'1.9','visit add serviceplan','SQL','V1_9__visit_add_serviceplan.sql',-238654323,'root','2017-07-29 02:29:52',529,1);
